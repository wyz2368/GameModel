...
from deeprl import build_act, build_train_att, build_train_def
from deeprl.replay_buffer import ReplayBuffer, PrioritizedReplayBuffer
from deeprl.utils import ObservationInput

from common.tf_util import get_session
# from deeprl.models import build_q_func
...
def learn_def(env,
    ...
    act, train, update_target, debug = build_train_def(
        make_obs_ph=make_obs_ph,
        q_func=q_func,
        num_actions=env.action_space.n,
        optimizer=tf.train.AdamOptimizer(learning_rate=lr),
